...
<div class="modal-body">
    <p>At METZ CARS S.R.L., accessible from https://metzcars.com, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by METZ CARS S.R.L. and how
        we use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in METZ CARS S.R.L.. This policy is not applicable to any
    ...
    <p>METZ CARS S.R.L. follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <p>Like any other website, METZ CARS S.R.L. uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on METZ CARS S.R.L., which are sent directly to users' browser.
    ...
    <p>Note that METZ CARS S.R.L. has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h4>Third Party Privacy Policies</h4>

    <p>METZ CARS S.R.L.'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
